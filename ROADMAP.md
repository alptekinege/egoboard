...
> R0–R2 are sequential (shell before surfaces). R3–R6 can reorder by need — each ships independently. **U19 (P0), U17/U18/U20 (P1) are delivered**; remaining: U14/U15 (Settings search, profiles, tour), R4 undo/progress polish, §8 platform items.
...
*Last updated: 2026-09-22 (status synced: U1–U9, U16–U20 delivered; U11–U13 partial; U14/U15 open) · Next: U14/U15 (Settings search + reset + profiles, first-run tour) or R4 leftovers.*
