...
1. **R4 feedback and states:** complete U11 undo semantics (including expiry and bulk operations), cancellable progress for backup/import/export/restore, and non-blocking loading placeholders (U12 motion and U13 empty/error states delivered 2026-09-23). Keep `Reduce motion` and accessibility behavior throughout.
...
| **R4 — Feedback & states ◐ partial** | Skeletons, empty-state/toast/motion foundations, capture sound+notification, bulk image export, shared motion and empty/error states delivered; undo/progress polish remains | U11, **U12** ✅, **U13** ✅, **U16** ✅, **U17** ✅ |
...
> R0–R2 are sequential (shell before surfaces). R3–R6 can reorder by need — each ships independently. **U12/U13/U19 (P0), U17/U18/U20 (P1) are delivered**; remaining: U14/U15 (Settings search, profiles, tour), R4 undo/progress polish (U11), §8 platform items.
...
*Last updated: 2026-09-23 (status synced: U1–U9, U12/U13, U16–U20 delivered; U11 partial; U14/U15 open) · Next: R4 leftovers (U11 undo/progress) or U14/U15 (Settings search + reset + profiles, first-run tour).*
