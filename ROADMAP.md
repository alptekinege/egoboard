...
> R0–R2 are sequential (shell before surfaces). R3–R6 can reorder by need — each ships independently. **U11/U12/U13/U14/U15/U19 (P0), U17/U18/U20 (P1) are delivered**; R4 ✅, R5 ✅; remaining: U10 groups tail, §8 platform items.
...
*Last updated: 2026-09-23 (status synced: U1–U15, U16–U20 delivered; R4 ✅, R5 ✅; U10 partial — timeline keyboard/AT done) · Next: U10 groups tail (overlay drawer + drag count badge, narrow-combo variant), or §8/R6 platform tails.*
