...
| **R5 — Settings & onboarding** ◐ *partial (U19/U20 landed 2026-09-22)* | Settings search + reset + profiles + responsive dialog; settings JSON portability ✅ 2026-09-23; first-run tour; cheatsheet ✅ 2026-09-23; Settings crash hardening ✅ and crash-report toolkit ✅ | U14, U15, **U19** ✅, **U20** ✅ |
...
> R0–R2 are sequential (shell before surfaces). R3–R6 can reorder by need — each ships independently. **U11/U12/U13/U19 (P0), U17/U18/U20 (P1) are delivered**; remaining: U14/U15 (Settings search, profiles, tour), U10 groups tail, §8 platform items.
...
*Last updated: 2026-09-23 (status synced: U1–U13, U16–U20 delivered; R4 complete; U14 partial — portability + search + responsive done; U10 partial — timeline keyboard/AT done; U15 partial — cheatsheet done) · Next: U14 (per-page reset, profiles), U15 tour, or U10-groups/R6 tails.*
