...
4. **U10 and accessibility tail ✅ (groups + timeline done 2026-09-23):** keyboard navigation/accessible labels for timeline and groups (timeline keyboard + per-bar names; groups overlay drawer + drop count badge + narrow day combo), narrow groups overlay/empty state/count feedback. Remaining tail: touch scrolling and pseudo-long translation layout checks. High-contrast and keyboard-first behavior stay acceptance requirements.
...
> R0–R2 are sequential (shell before surfaces). R3–R6 can reorder by need — each ships independently. **U10/U11/U12/U13/U14/U15/U19 (P0), U17/U18/U20 (P1) are delivered**; R4 ✅, R5 ✅; remaining: touch/pseudo-long a11y tail, §8 platform items.
...
*Last updated: 2026-09-23 (status synced: U1–U20 delivered except §8/R6 platform tails; R4 ✅, R5 ✅; remaining tail: touch scrolling + pseudo-long checks, Wayland portal paste, screencast blur, KRunner preview) · Next: §8/R6 platform tails, then P1 docs/verification.*
