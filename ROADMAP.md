...
3. **R6 platform polish ◐ partial:** provide the opt-in Wayland portal paste consent/revocation flow (delivered 2026-09-23: `PortalPaster` RemoteDesktop Ctrl+V behind `portalPasteEnabled`, per-session compositor consent, notification fallback always stays), best-effort screencast status/blur, and KRunner live preview/result categories (categories delivered 2026-09-23: content-type grouping with relevance ordering; KRunner has no preview-pane API — per-keystroke multi-line match text is the live preview). U18 tray refresh is complete; retain parity across SNI and fallback surfaces.
...
| **R6 — Platform polish** ◐ *partial* | Portal-paste consent ✅ 2026-09-23, screencast blur, KRunner categories ✅ 2026-09-23, tray UI refresh ✅ | **U18** ✅, §8 |
...
*Last updated: 2026-09-23 (status synced: U1–U20 delivered; R4 ✅, R5 ✅; R6 partial — KRunner categories + portal paste done; P0 tails done — touch scrolling + pseudo-long checks; remaining: screencast blur, then P1 docs/verification, P2 proposals) · Next: screencast blur.*
