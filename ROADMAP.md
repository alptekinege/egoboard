...
| **R5 — Settings & onboarding** ◐ *partial (U14 ✅ 2026-09-23, U19/U20 landed 2026-09-22)* | Settings search + reset + profiles + responsive dialog; settings JSON portability ✅ 2026-09-23; per-page reset ✅ 2026-09-23; profiles ✅ 2026-09-23; first-run tour; cheatsheet ✅ 2026-09-23; Settings crash hardening ✅ and crash-report toolkit ✅ | **U14** ✅, U15, **U19** ✅, **U20** ✅ |
...
> R0–R2 are sequential (shell before surfaces). R3–R6 can reorder by need — each ships independently. **U11/U12/U13/U14/U19 (P0), U17/U18/U20 (P1) are delivered**; remaining: U15 tour, U10 groups tail, §8 platform items.
...
*Last updated: 2026-09-23 (status synced: U1–U14, U16–U20 delivered; R4 complete; U14 complete — portability + search + responsive + per-page reset + profiles done; U10 partial — timeline keyboard/AT done; U15 partial — cheatsheet done) · Next: U15 tour, or U10-groups/R6 tails.*
